    ...
    */
    ...
    useEffect(() => {
        const getMessages = async () => {
            try {
                const res = await axios.get(`https://swampysells-api.onrender.com/api/messages/${currentChat._id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        */
        ...
        try {
            const res = await axios.post("https://swampysells-api.onrender.com/api/messages", message);
